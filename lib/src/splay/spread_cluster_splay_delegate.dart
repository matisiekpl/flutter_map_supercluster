...
class SpreadClusterSplayDelegate extends ClusterSplayDelegate {
  ...
  List<DisplacedMarker> displaceMarkers(
    ...
    required Point<double> Function(LatLng latLng) project,
    required LatLng Function(Point<double> point) unproject,
  }) {
  ...
  List<DisplacedMarkerOffset> displacedMarkerOffsets(
    ...
    double animationProgress,
    Point<double> Function(LatLng point) getPixelOffset,
